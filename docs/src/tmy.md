...
| Endpoint                | API Docs                                                                                                                                            |
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| `radiation_and_weather` | [details](https://docs.solcast.com.au/?#e75039fa-86ec-43e4-99a3-389d3d7a4a99)  |
| `rooftop_pv_power`      | [details](https://docs.solcast.com.au/?#d117fde9-e410-4df0-bd07-e6168efd23cf)  |
